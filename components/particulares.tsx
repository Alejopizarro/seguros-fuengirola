...
const Particulares = () => {
  ...
  return (
    <div className="bg-gray-800">
      <div className="flex flex-col gap-4 max-w-[1440px] mx-auto sm:flex-row p-8 sm:px-12 sm:py-18 items-center justify-between ">
        <div className="flex flex-col gap-4 max-w-2xl 2xl:max-w-4xl mb-4 sm:mb-0">
          ...
          <p className="font-bold text-3xl sm:text-4xl 2xl:text-6xl leading-none tracking-tight sm:w-3/4 text-slate-50">
            Seguros de salud para acceder al mejor servicio de la medicina
            privada
          </p>
